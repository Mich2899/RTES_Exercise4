...
int main(int argc, char **argv)
{
   ...
   pthread_attr_setaffinity_np(&main_sched_attr,sizeof(cpu_set_t),&threadcpu);
...
//   rc = pthread_create(&main_thread, &main_sched_attr, mainloop, NULL);
   ...
   if (rc)
   {
    ...
    syslog(LOG_CRIT, "dump_check called no. of times: %d\n", dump_check);
